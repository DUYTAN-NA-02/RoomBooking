import { collection, getDocs, addDoc, updateDoc, deleteDoc, query, where } from "./Init.js";
...
async function getUserByUsernameAndPassword(db, username, password) {
    const userCol = collection(db, 'users');
    const q = query(userCol, where('name', '==', username), where('password', '==', password));
...
export { getUsers, getUserByUsername, getUserByUsernameAndPassword, getUserById, addUser, updateUser, deleteUser};